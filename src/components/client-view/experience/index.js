              ...
              <h1 className="leading-[70px] mb-4 text-3xl lg:text-4xl xl:text-5xl font-medium">
                {"My Experience".split(" ").map((item, index) => (
                  <span
                    ...
                    className={`${
                      index === 1 ? "text-green-400" : "text-[#000]"
                    }`}
                  >
                    {item}{" "}
                  </span>
              ...
              <motion.div className="container">
                <Timeline position="right">
                  {experienceData && experienceData.length
                    ? experienceData.map((experienceItem, idx) => (
                        <TimelineItem key={idx}> {/* Add key here */}
                          <TimelineSeparator>
                            <TimelineDot className="bg-green-400" />
                            <TimelineConnector className="bg-green-400" />
                          </TimelineSeparator>
                          <TimelineContent>
                            <div className="border-[2px] p-4 rounded-[8px] border-green-400 mt-[14px] ml-[16px]">
